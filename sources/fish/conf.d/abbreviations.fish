...
abbr --add dkcpb "docker compose build --pull"
...
abbr --add dkcplg "docker compose logs -f"
...
abbr --add dkcpup "docker compose up -d --pull always --build --remove-orphans --renew-anon-volumes"
